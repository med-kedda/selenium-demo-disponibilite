...
public class SeleniumDisponibilite {
	...
	public static void main(String[] args) throws Exception {
		...
		driver.get("https://disponibilite.eserviceslab.com");
	...
	private static void addDemand() throws Exception {
		...
		WebElement selectMinistry = findElementByXpath("//*[@id=\"ministre\"]");
		WebElement selectDuration = findElementByXpath("//*[@id=\"dispoDuration\"]");
		WebElement LettreInput = findElementByXpath("//*[@id=\"dmd\"]/div/div/div");

		Thread.sleep(3000);
		if (selectMinistry.isDisplayed() && selectDuration.isDisplayed() && LettreInput.isDisplayed()) {

			Select selectedMinisry = new Select(selectMinistry);
			selectedMinisry.selectByIndex(1);
			
			Select selectedDuration = new Select(selectDuration);
			selectedDuration.selectByIndex(1);
